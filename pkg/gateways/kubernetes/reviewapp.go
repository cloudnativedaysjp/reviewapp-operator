...
func (c Client) GetReviewApp(ctx context.Context, namespace, name string) (dreamkastv1alpha1.ReviewApp, error) {
	...
	if err := c.Get(ctx, nn, &ra); err != nil {
		...
		if apierrors.IsNotFound(err) {
			return dreamkastv1alpha1.ReviewApp{}, myerrors.NewK8sObjectNotFound(wrapedErr, ra.GVK(), nn)
		}
		return dreamkastv1alpha1.ReviewApp{}, wrapedErr
	}
	ra.SetGroupVersionKind(ra.GVK())
	return ra, nil
}

func (c Client) ApplyReviewAppWithOwnerRef(ctx context.Context, ra dreamkastv1alpha1.ReviewApp, owner dreamkastv1alpha1.ReviewAppManager) error {
...
func (c Client) PatchReviewAppStatus(ctx context.Context, ra dreamkastv1alpha1.ReviewApp) error {
