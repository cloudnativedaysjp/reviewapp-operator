...
func (c Client) GetArgoCDAppFromReviewAppStatus(ctx context.Context, raStatus dreamkastv1alpha1.ReviewAppStatus) (dreamkastv1alpha1.Application, error) {
	...
	nn := types.NamespacedName{Namespace: raStatus.ManifestsCache.ApplicationNamespace, Name: raStatus.ManifestsCache.ApplicationName}
	...
	return dreamkastv1alpha1.Application(b), nil
}
