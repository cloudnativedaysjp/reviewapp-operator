...
type GitLocalRepoIface interface {
	WithCredential(credential models.GitCredential) error
	ForceClone(context.Context, dreamkastv1alpha1.ReviewAppCommonSpecInfraTarget) (models.InfraRepoLocalDir, error)
...
func NewGitLocalRepo(l logr.Logger, e exec.Interface) (*GitLocalRepo, error) {
	// create basedir
	basedir := BaseDir
	...
	return &GitLocalRepo{logger: l, exec: e, baseDir: basedir}, nil
}

func (g *GitLocalRepo) WithCredential(credential models.GitCredential) error {
...
func (g *GitLocalRepo) ForceClone(ctx context.Context, infraTarget dreamkastv1alpha1.ReviewAppCommonSpecInfraTarget) (models.InfraRepoLocalDir, error) {
	...
	gp := models.NewInfraRepoLocalDir(downloadDir)
...
func (g *GitLocalRepo) CreateFiles(ctx context.Context, gp models.InfraRepoLocalDir, files ...models.File) error {
	for _, f := range files {
...
func (g *GitLocalRepo) DeleteFiles(ctx context.Context, gp models.InfraRepoLocalDir, files ...models.File) error {
	for _, f := range files {
		fpath := filepath.Join(gp.BaseDir(), f.Filepath)
...
func (g *GitLocalRepo) CommitAndPush(ctx context.Context, gp models.InfraRepoLocalDir, message string) (*models.InfraRepoLocalDir, error) {
...
func (g *GitLocalRepo) updateLatestCommitHash(ctx context.Context, gp models.InfraRepoLocalDir) (models.InfraRepoLocalDir, error) {
...
func (g *GitLocalRepo) runCommand(ctx context.Context, basedir string, cmd string, args ...string) (bytes.Buffer, bytes.Buffer, error) {
	stdout := bytes.Buffer{}
	stderr := bytes.Buffer{}
