...
func (r *ReviewAppManagerReconciler) reconcile(ctx context.Context, ramInput *dreamkastv1alpha1.ReviewAppManager) (ctrl.Result, error) {
	// init model
	ram := models.NewReviewAppManager(*ramInput)
