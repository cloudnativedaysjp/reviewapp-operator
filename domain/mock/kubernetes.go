...
func (m *MockKubernetesRepository) GetArgoCDAppFromReviewAppStatus(ctx context.Context, ra models.ReviewApp) (models.Application, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetArgoCDAppFromReviewAppStatus", ctx, ra)
...
func (mr *MockKubernetesRepositoryMockRecorder) GetArgoCDAppFromReviewAppStatus(ctx, ra interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetArgoCDAppFromReviewAppStatus", reflect.TypeOf((*MockKubernetesRepository)(nil).GetArgoCDAppFromReviewAppStatus), ctx, ra)
}
...
// UpdateReviewAppStatus mocks base method.
func (m *MockKubernetesRepository) UpdateReviewAppStatus(ctx context.Context, ra models.ReviewApp) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateReviewAppStatus", ctx, ra)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateReviewAppStatus indicates an expected call of UpdateReviewAppStatus.
func (mr *MockKubernetesRepositoryMockRecorder) UpdateReviewAppStatus(ctx, ra interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateReviewAppStatus", reflect.TypeOf((*MockKubernetesRepository)(nil).UpdateReviewAppStatus), ctx, ra)
}
