...
// ApplyReviewAppStatus mocks base method.
func (m *MockKubernetesRepository) ApplyReviewAppStatus(ctx context.Context, ra models.ReviewApp) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ApplyReviewAppStatus", ctx, ra)
	ret0, _ := ret[0].(error)
	return ret0
}

// ApplyReviewAppStatus indicates an expected call of ApplyReviewAppStatus.
func (mr *MockKubernetesRepositoryMockRecorder) ApplyReviewAppStatus(ctx, ra interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ApplyReviewAppStatus", reflect.TypeOf((*MockKubernetesRepository)(nil).ApplyReviewAppStatus), ctx, ra)
}
